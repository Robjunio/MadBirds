...
{
    private Vector3 _initialPosition;  // O '_' é para marcar variaveis privadas.
    private bool _birdwasLaunched;
    private float _timeSittingAround;
    
     /* Insere um campo para alterar o valor da variavel sem ter
      que mexer diretamente no codigo.*/
